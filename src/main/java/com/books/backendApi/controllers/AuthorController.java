...
import com.books.backendApi.domain.dto.AuthorDto;
...
public class AuthorController {
    ...
    public ResponseEntity<AuthorDto> createAuthor(@RequestBody AuthorDto authorDto){
        AuthorEntity resultEntity = authorMapper.mapFrom(authorDto);
        AuthorEntity savedAuthorEntity = authorService.save(resultEntity);
